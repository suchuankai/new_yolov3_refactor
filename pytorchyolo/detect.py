...
class Detect(Top):
    ...
    def detect_directory(self, model_path, weights_path, img_path, classes, output_path,
        ...
        """
        dataloader = self._create_data_loader(img_path, batch_size, img_size, n_cpu)
        model = load_model(model_path, weights_path)
        img_detections, imgs = self.detect(
            model,
            dataloader,
            output_path,
            conf_thres,
            nms_thres)
        self._draw_and_save_output_images(
            img_detections, imgs, img_size, output_path, classes)

        print(f"---- Detections were saved to: '{output_path}' ----")


    def detect_image(self, model, image, img_size=416, conf_thres=0.5, nms_thres=0.5):
    ...
    def detect(self, model, dataloader, output_path, conf_thres, nms_thres):
    ...
    def _draw_and_save_output_images(self, img_detections, imgs, img_size, output_path, classes):
        ...
        for (image_path, detections) in zip(imgs, img_detections):
            ...
            self._draw_and_save_output_image(
                image_path, detections, img_size, output_path, classes)


    def _draw_and_save_output_image(self, image_path, detections, img_size, output_path, classes):
